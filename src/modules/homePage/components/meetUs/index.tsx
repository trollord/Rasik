...
function MeetUs() {
  ...
  return (
   <Grid  columnSpacing={5} p={3} width='85%'  bgcolor='#EADBC8'  height='300px' m='auto' container display='flex' justifyContent='space-evenly' mb={5} boxShadow='0px 4px 4px 0px #00000040' borderRadius='10px'>

    <Grid item md={6}  height='200px' m='auto 0' border={2} bgcolor='#000' borderRadius='10px'>
    <GoogleMapReact
