        ...
        {!isTablet && <Grid container item md={3} justifyContent='left' flexDirection='column' height = "53vh" >
          ...
          <Box style={{ display: 'flex', flexDirection: 'column', gap: '10px', justifyContent: 'left' }}  >
            ...
            <Box height="5vh" marginBottom="1vw">
              ...
              <Typography sx={{ fontSize: { xs: '4vw', md: '1vw' } }}> Phone : <a href="tel:+919821028256" style={{ color: 'black', textDecoration: 'none' }}>+91-9821028256</a></Typography>

            </Box>
            <Box height="5vh" marginBottom="1vw">
              <Typography sx={{ fontSize: { xs: '4vw', md: '1vw' } }}>Mr. Rohit Naik</Typography>
              <Typography sx={{ fontSize: { xs: '4vw', md: '1vw' } }}>Phone : <a href="tel:+919768001616" style={{ color: 'black', textDecoration: 'none' }}>+91-9768001616</a></Typography>
            </Box>
            <Box height="5vh" marginBottom="1vw">
              <Typography sx={{ fontSize: { xs: '4vw', md: '1vw' } }}>Mr. Vishal jadhav</Typography>
              <Typography sx={{ fontSize: { xs: '4vw', md: '1vw' } }}>Phone : <a href="tel:+919773773434" style={{ color: 'black', textDecoration: 'none' }}>+91-9773773434</a></Typography>
            </Box>
            <Box height="5vh" marginBottom="1vw">
              <Typography sx={{ fontSize: { xs: '4vw', md: '1vw' } }}>Ms. Twinkle Shah</Typography>
