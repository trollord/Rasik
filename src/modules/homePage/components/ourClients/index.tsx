...
function OurClients() {
    return (
        ...
        <Grid container display='flex' alignItems='center' flexDirection='column' sx={{ height: { xs: '50vh', md: '110vh'}, justifyContent: { xs: 'center', md: 'center' },margin:{md:'20px 0 0'} }} id='client' >
            <Box width="100%" >
