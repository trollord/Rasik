...
function FooterMobile() {
    ...
    return (
        ...
        <Grid>
            ...
            <Grid display="flex" justifyContent="center" direction={"column"}  height="6vh" width="100vw" >
             <Box className={styles.rasikCommunicationsAllRighWrapper2} height="6vh" display={"flex"} flexDirection={"column"} justifyContent="center" textAlign="center" >
