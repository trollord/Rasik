...
function ContactUs() {
  ...
  return (
    ...
    <Grid container width='90%' spacing={2} m='auto' sx={{ flexDirection: isMobile ? 'row' : 'row', padding: { xs: '5px 20px', md: '30px' }, height: { xs: '80vh', md: '85vh' } }} id='contactUs' className="element">
